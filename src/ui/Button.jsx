...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      'inline-block text-sm rounded-full font-semibold border-2 border-stone-300 uppercase tracking-wide text-stone-500 transition-colors hover:bg-stone-300 hover:text-stone-800 focus:bg-stone-300 focus:outline-none  focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2 md:px-6 md:py-3.5',
  };
